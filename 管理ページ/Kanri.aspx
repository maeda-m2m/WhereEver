         ...
         <span class="hr"></span>
           ...
           <div id="TestSystem">
            ...
            <div class="center">
               ...
               <asp:Button ID="Button_XHTMLButton" runat="server" CssClass="btn_loginlist" Text="ボタンとQR生成を試す" OnClick="btnButton_Click" />
               <asp:Button ID="Button_DP" runat="server" CssClass="btn_loginlist" Text="誤差逆伝搬法を試す" OnClick="btnDP_Click" />
            </div>
           </div>
