...
namespace WhereEver
{
    public partial class PrintSchedule : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet1.T_Schedule3DataTable dd = Class2.Insatsu1(Global.GetConnection());


            for (int j = 0; j < dd.Count; j++)

            {
                DataSet1.T_Schedule3Row dr = dd.Rows[j] as DataSet1.T_Schedule3Row;
            ...
            DataSet1.T_Schedule3DataTable dp = Class2.Insatsu2(Global.GetConnection());


            for (int j = 0; j < dp.Count; j++)

            {
                DataSet1.T_Schedule3Row dr = dp.Rows[j] as DataSet1.T_Schedule3Row;
